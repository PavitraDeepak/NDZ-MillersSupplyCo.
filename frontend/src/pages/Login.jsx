          ...
          <form onSubmit={handleLogin} className="mt-6 w-full flex flex-col flex-1">
            <div className="w-full mb-3">
              ...
              <input 
                ...
                className="w-full h-[42px] px-[14px] border border-[#dde3e8] rounded-[4px] text-[12px] text-[#5f6673] outline-none focus:border-[#1d7c67]" required/>
            </div>

            <div className="w-full mb-3">
              <label className="block text-[12px] text-[#7c8594] mb-[5px] text-left">Password</label>
              <input type="password" value={password}onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" className="w-full h-[42px] px-[14px] border border-[#dde3e8] rounded-[4px] text-[12px] text-[#5f6673] outline-none focus:border-[#1d7c67]" required/>
            </div>
            ...
            <div className="w-full flex justify-between items-center mt-[2px] mb-8 text-[11px]">
              <div className="flex items-center gap-[8px] text-[#7c8594]">
                <input 
                  ...
                  className="appearance-none w-[14px] h-[14px] border border-[#cfd8dc] rounded-[3px] bg-white cursor-pointer checked:bg-[#1d7c67]"
                />
