  ...
  return (
    <div className="p-8 min-h-screen bg-gray-50">
      <div className="grid grid-cols-12 gap-8 items-start">
        ...
        <div className="col-span-12 lg:col-span-9 bg-white p-6 rounded-xl border border-gray-200 shadow-sm h-full">
        ...
        <div className="col-span-12 lg:col-span-3 bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col h-full">
          <h3 className="font-bold text-lg mb-6">Order Summary</h3>
          <div className="space-y-1 mb-4 border-b border-gray-100 pb-4">
            <div className="flex justify-between py-2"><span className="text-sm text-gray-600">Total Items</span><span className="text-sm font-bold">3</span></div>
            <div className="flex justify-between py-2"><span className="text-sm text-gray-600">Total Quantity</span><span className="text-sm font-bold">100 MT</span></div>
          </div>
        ...
        <div className="col-span-12 bg-white p-6 rounded-xl border border-gray-200 shadow-sm mt-4">
